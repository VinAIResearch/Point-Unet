        ...
        cfg = AutoResumeTrainConfig(
            ...
            callbacks=[
                ...
                ScheduledHyperParamSetter('learning_rate', 
                    [(20, config.BASE_LR*0.5),
                    (40, config.BASE_LR*0.1),
                    (50, config.BASE_LR*0.05),
                    (60, config.BASE_LR*0.01),
                    (115, config.BASE_LR*0.005),
                    (130, config.BASE_LR*0.001),
                    (140, config.BASE_LR*0.0005),
                    (150, config.BASE_LR*0.0001),
                    (155, config.BASE_LR*0.00005),
                    (160, config.BASE_LR*0.00001)]
                ),
                #EvalCallback(),
