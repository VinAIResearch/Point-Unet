...
if __name__ == '__main__':
    ...
    parser.add_argument('--inPros_path', type=str, default="/dataset/BraTS2020/predict_npy/", help='path to the probability of PointSegment output')
    parser.add_argument('--outSegment_path', type=str, default='/dataset/BraTS2020/predict_nii', help='path to the final segmentation results')
