...
if __name__ == '__main__':
    ...
    parser.add_argument('--inPros_path', type=str, default=0, help='path to the probability of PointSegment output')
    parser.add_argument('--outSegment_path', type=str, default='train', help='path to the final segmentation results')
